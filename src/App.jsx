...
import ProductFiles from "./Pages/ProductFile";
import ProductFileForm from "./Components/ProductFileForm";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (token !== undefined && token !== null && token !== "") {
      ...
      fetchDataFromApi(`/api/user/user-details/${userId}`).then((res) => {
